...
export const ExportVideoPanel = observer(() => {
  ...
  const handleExportToJson = () => {
    const jsonOutput = store.exportToJson();
    if (jsonOutput) {
  ...
  return (
    <>
      ...
      <button
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-1 rounded-lg m-4"
        onClick={handleExportToJson}
      >
        Export as JSON
      </button>

      {/* Existing buttons and other UI elements */}
      <button
